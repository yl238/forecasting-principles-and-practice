...
class NaiveSeasonal(SimpleTSModel):
    ...
    def __init__(self, y, lag):
        ...
        self.lag = lag
        assert (
            self.y.index.min() + lag * (self.freq or 1) < self.y.index.max()
